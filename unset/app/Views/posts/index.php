...
<div id="div">
	...
	padding: 10px;">
            ...
            <footer id="f" style="padding:5px; background:#ddd; text-align:left;font-size:9pt; color:grey">Escrito por: <?=$posts['nome']?> no dia:         <?=Valida::ANG($posts['dataposts'])?> 
            </footer>
        </div>
            <?php endforeach?> 
            <?php else:?>
