...
<article id="noticia">
    <header id="cabecalho2">
        <hgroup>
            <h3>Posts > Actualizar</h3>
            <h1>Formulário de Actualização de Posts</h1>
            <h2>por Victor Clever</h2>
            <h3 class="direita">Atualizado em 27/Agosto/2022</h3>
        </hgroup>
    </header>
...
<ul id='ul'>
  ...
  <li id='li'><a  id="aa"  >Actualizar</a></li>
  

</ul>
    <form method="post" action="<?= URL."post/editar/".$dados['id']?>">
        <fieldset id="usuario">
           ...
           <p>
           <button type="submit" name="cad" value="Cadastrar" style="width: 90%;">Actualizar</button>
