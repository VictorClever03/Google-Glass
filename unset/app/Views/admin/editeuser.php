    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h4>Editar Usuario</h1>
                <form method="POST" action="<?= URL ?>admin/editeusers/<?=$dados['user']['id']?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="senha" id="senha"  class="form-control <?= $dados['erro_senha'] ? 'is-invalid' : '' ?>">
                                        <div class="invalid-feedback">
                                            <?= $dados['erro_senha'] ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="data" id="data"  class="form-control <?= $dados['erro_data'] ? 'is-invalid' : '' ?> ">
                                        <div class="invalid-feedback">
                                            <?= $dados['erro_data'] ?>
                                        </div>
                                    </div>
                                    ...
                                    <button type="submit" class="btn btn-success col-12" name="cadd" value="cad">Actualizar</button>
                                </form>
