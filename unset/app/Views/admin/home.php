                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Usuarios</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$dados['users']['totalusers']?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">
                                                Solicitações &nbsp;\&nbsp; Atendidos</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$dados['pedidos']['totalpedidos']?> \ <?=$dados['pedidosA']['atend']?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?=$dados['posts']['totalposts']?></div>
                                        </div>
                                        <div class="col-auto">
