    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Basic Card Example -->
                <h1 class="h3 mb-2 text-gray-800">Pedidos</h1> <a href="<?=URL?>admin/atendidos">Pedidos atendidos</a>
                <?php if(isset($dados['pedidos'])):?>
                <?php foreach ($dados['pedidos'] as $key):?>
                    <div class="card shadow mb-4 ml-5 mr-5">
                        <div class="card-header py-3">
                        <div class="d-sm-flex align-items-center justify-content-between ">
                            <h6 class="m-0 font-weight-bold text-primary"><?=$key['nome']?></h6>
                            
                            <h6><small><?=Valida::ANG($key['pedido_em'])?></small></h6>
                        </div>
                        </div>
                        <div class="card-body">
                            Localidade: <?=$key['localidade']?> <br>
                            Contacto: <?=$key['numero']?> <br>
                            Grau Óptico: <?=$key['grau']?> <br>
                            Quantidade: <?=$key['quantidade']?> <br>
                            Preço a pagar: <?=$key['preco']?> <br>
                            <footer class="mt-2">
                                <a name="cad" href="<?=URL?>admin/atender/<?=$key['idpedido']?>" class="btn btn-success">                   
                                    Atender
                                </a></footer>
