...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item -->
            <li class="nav-item">
                <a href="<?= URL ?>admin/createuser" class="nav-link">
                ...
                <h1 class="h3 mb-2 text-gray-800">Posts</h1>
                    <div class="card shadow mb-4 ml-5 mr-5">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between ">
                            <h6 class="m-0 font-weight-bold text-primary"><?= $dados['posts']['titulo'] ?></h6>
                            
                            <h6><small><?=$dados['posts']['nome']?> <?php if($_SESSION['usuarios_id']==$dados['posts']['idusuarios']): echo "(admin)"; endif;?></small></h6>
                        </div>
                        </div>
                        <div class="card-body">
                            <?= $dados['posts']['mensagem'] ?>
                            <?php if($_SESSION['usuarios_id']==$dados['posts']['idusuarios']):?>
                                <footer class="mt-2">
                                <a name="cad" href="<?=URL?>admin/editarpost/<?=$dados['posts']['idposts']?>" class="btn btn-success">                   
                                    editar
                                </a></footer>
                                <?php endif;?>
                        </div>
